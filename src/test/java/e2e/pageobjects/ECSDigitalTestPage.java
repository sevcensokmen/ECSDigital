...
public class ECSDigitalTestPage {
    ...
    public ArrayList<Integer> getArray(int row) {
        ...
        values.add(Integer.parseInt(DriverManager.getDriver().findElement(By.xpath("//tr[" + row + "]//td[1]")).getText()));
        values.add(Integer.parseInt(DriverManager.getDriver().findElement(By.xpath("//tr[" + row + "]//td[2]")).getText()));
        values.add(Integer.parseInt(DriverManager.getDriver().findElement(By.xpath("//tr[" + row + "]//td[3]")).getText()));
        values.add(Integer.parseInt(DriverManager.getDriver().findElement(By.xpath("//tr[" + row + "]//td[4]")).getText()));
        values.add(Integer.parseInt(DriverManager.getDriver().findElement(By.xpath("//tr[" + row + "]//td[5]")).getText()));
        values.add(Integer.parseInt(DriverManager.getDriver().findElement(By.xpath("//tr[" + row + "]//td[6]")).getText()));
        values.add(Integer.parseInt(DriverManager.getDriver().findElement(By.xpath("//tr[" + row + "]//td[7]")).getText()));
        values.add(Integer.parseInt(DriverManager.getDriver().findElement(By.xpath("//tr[" + row + "]//td[8]")).getText()));
        values.add(Integer.parseInt(DriverManager.getDriver().findElement(By.xpath("//tr[" + row + "]//td[9]")).getText()));
